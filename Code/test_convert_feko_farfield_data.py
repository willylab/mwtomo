...
if __name__ == '__main__':
    ...
    for t_Baris in t_Lines:
        ...
        if t_Baris.find("VALUES OF THE SCATTERED ELECTRIC FIELD STRENGTH IN THE FAR FIELD in V") != -1:
            t_Found = True
            t_Count += 1
            t_Array = []
            print('----------------------')
        ...
        if t_Baris.find("read from buffer:") != -1 and t_Found==True:
            t_Found = False
            ...
            for t_Data in t_Array[5:-1]:
                t_DataSplited = t_Data.replace(" ", ";")
                t_Data0 = t_DataSplited.replace(";;;;", ";")
                t_Data1 = t_Data0.replace(";;;", ";")
